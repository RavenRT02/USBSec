...
# Registration/email/OTP dependencies
import smtplib, re, hashlib, random, string, sqlite3, time
...
class UserManager:
    ...
    def load_smtp_config():
        ...
        part1 = b'98kJGZ0pA_x73airzZm4m6'
        part2 = b'pmlsrVOlQVvbP226bKu4I='
        embedded_key = part1 + part2
        try:
            fernet = Fernet(embedded_key)
            with open("smtp.enc", "rb") as enc_file:
...
class ProjectInfo:
    ...
    @staticmethod
    def open():
        path = ProjectInfo.resource_path("project_info.html")
...
class LoginWindow:
    def __init__(self, master, on_success):
        ...
        self.login_window.geometry("370x280")
    ...
    def setup_ui(self):
        def login():
            ...
            if not user_data or user_data[3] != hashed_password:
...
class MainAppWindow:
    ...
    def setup_ui(self):
        ...
        pinfo_button = ctk.CTkButton(master=button_frame, text="Project Info", hover_color="#d15a15", command=ProjectInfo.open)
